...
def regresion():
    resultado, error, pos, neg, exe_time=resultadosPregunta2()
    return render_template('regresion.html',resultado=resultado, error=error, pos=pos, neg=neg, exe_time=exe_time)
